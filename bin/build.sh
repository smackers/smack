...
case "$distro" in
linux-opensuse*)
  Z3_DOWNLOAD_LINK="https://github.com/Z3Prover/bin-old/blob/8c219e1c4ffb2f45bf4741d76075b974d5e7990e/z3-4.4.0.1abeb825a35a-x64-debian-7.8.zip?raw=true"
  DEPENDENCIES+=" llvm-clang llvm-devel gcc-c++ mono-complete make"
  DEPENDENCIES+=" ncurses-devel zlib-devel"
  ;;

linux-ubuntu-14*)
  Z3_DOWNLOAD_LINK="https://github.com/Z3Prover/bin-old/blob/f139669240f613e86cac199e518dbc3541cf16bd/z3-4.4.0.1abeb825a35a-x64-ubuntu-14.04.zip?raw=true"
