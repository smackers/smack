...
pub struct Arr {
    pub len: usize,
    pub sz: usize,
    pub data: Unique<Labeled<Secret>>,
}
...
/*        for i in 0..sz*ds {
        ...
        Arr{len: 0, sz: sz, 
            data: unsafe{Unique::new(mem::transmute::<*mut u8, *mut Labeled<Secret>>(dt))}}
    }
...
//            println!("Reallocating");
            self.data = unsafe{Unique::new(myrealloc(self.data.offset(0) as *mut u8, 
...
//        println!("Dropping");
        ...
        unsafe{free(self.data.offset(0) as *mut u8)};
