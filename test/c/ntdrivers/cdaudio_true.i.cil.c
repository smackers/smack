...
NTSTATUS SendSrbSynchronous(PCD_DEVICE_EXTENSION Extension,
                            PSCSI_PASS_THROUGH Srb, PVOID Buffer,
                            ULONG BufferLength) {
  ULONG ioctl;
  KEVENT event;
  PIRP irp;
...
NTSTATUS CdAudioAddDevice(PDRIVER_OBJECT DriverObject,
...

  {
    {
      regActive = 255;
      status = IoOpenDeviceRegistryKey(PhysicalDeviceObject, 2, 131097L,
    ...
    }
    {
      ...
      status =
          RtlQueryRegistryValues(1073741824, (WCHAR *)deviceParameterHandle,
                      ...
                      if (regActive == 7) {
                        ...
                        if (regActive == 255) {
                        ...
                        } else {
                          {
                            ...
                            {
                              MmLockPagableDataSection(
                                  (void *)(&CdAudioPioneerDeviceControl));
                            }
                              goto switch_0_break;
                            switch_0_4 : /* CIL Label */
                            {
                              MmLockPagableDataSection(
                                  (void *)(&CdAudioDenonDeviceControl));
                            }
                              goto switch_0_break;
                            ...
                            {
                              MmLockPagableDataSection(
                                  (void *)(&CdAudioHitachiDeviceControl));
                            }
                              goto switch_0_break;
                            ...
                            {
                              MmLockPagableDataSection(
                                  (void *)(&CdAudio435DeviceControl));
                            }
                              goto switch_0_break;
                            switch_0_1 : /* CIL Label */
                            {
                              MmLockPagableDataSection(
                                  (void *)(&CdAudioAtapiDeviceControl));
                            }
                              goto switch_0_break;
...
NTSTATUS CdAudioStartDevice(PDEVICE_OBJECT DeviceObject, PIRP Irp) {
...

  {
    ...
    }
    {
      ...
      status = IoOpenDeviceRegistryKey(deviceExtension->TargetPdo, 2, 131078L,
                                       &deviceParameterHandle);
    }
    if (!(status >= 0L)) {
      return (0L);
    ...
    {
      status = RtlWriteRegistryValue(1073741824, (WCHAR *)deviceParameterHandle,
                                     "M\000a\000p\000T\000y\000p\000e\000", 4,
          ...
          switch_2_22: /* CIL Label */;
            ...
            }
            {
              ...
              status = KeWaitForSingleObject(
                  &deviceExtension->PagingPathCountEvent, 0, 0, 0, (void *)0);
              setPagable = 0;
            }
...
BOOLEAN CdAudioIsPlayActive(PDEVICE_OBJECT DeviceObject) {
...

  {
    ...
    {
      tmp =
          ExAllocatePoolWithTag(4, sizeof(SUB_Q_CURRENT_POSITION), 541156419UL);
      currentBuffer = tmp;
    }
            ...
            if (currentIrpStack->Parameters.DeviceIoControl.IoControlCode ==
              ...
              if (currentIrpStack->Parameters.DeviceIoControl.IoControlCode ==
                ...
                if (currentIrpStack->Parameters.DeviceIoControl.IoControlCode ==
                  ...
                  if (currentIrpStack->Parameters.DeviceIoControl
                          .IoControlCode ==
                      (((2 << 16) | (1 << 14)) | (11 << 2))) {
                    goto switch_4_exp_7;
                  } else {
                            ...
                            if (currentIrpStack->Parameters.DeviceIoControl
                            ...
                            } else {
                              {
                                ...
                                switch_4_exp_0: /* CIL Label */;
                                  ...
                                  {
                                    bytesTransfered =
                                        (long)(&((CDROM_TOC *)0)->TrackData[1]);
                                    Irp->IoStatus.Information = bytesTransfered;
                                    memset(cdaudioDataOut, 0, bytesTransfered);
                                    cdaudioDataOut->Length[0] =
                                        (unsigned char)((bytesTransfered -
                                                         2UL) >>
                                                        8);
                                    cdaudioDataOut->Length[1] =
                                        (unsigned char)((bytesTransfered -
                                                         2UL) &
                                                        255UL);
                                  }
                                  ...
                                  }
                                  {
                                    ...
                                    cdaudioDataOut->TrackData[0].Control =
                                        (((int)*(Toc + 2) & 15) << 4) |
                                        ((int)*(Toc + 2) >> 4);
                                    cdaudioDataOut->TrackData[0].TrackNumber =
                                        1;
                                    ...
                                    address =
                                        ...
                                        ((((int)*(Toc + 17) & 240) >> 4) * 10 +
                                         ((int)*(Toc + 17) & 15));
                                    cdaudioDataOut->TrackData[0].Address[0] =
                                        (unsigned char)(address >> 24);
                                    cdaudioDataOut->TrackData[0].Address[1] =
                                        (unsigned char)(address >> 16);
                                    cdaudioDataOut->TrackData[0].Address[2] =
                                ...
                                switch_4_exp_1 : /* CIL Label */
                                {
                                  ...
                                  if (currentIrpStack->Parameters
                                          .DeviceIoControl.OutputBufferLength >
                                      (ULONG)sizeof(CDROM_TOC)) {
                                    bytesTransfered = sizeof(CDROM_TOC);
                                  } else {
                                    bytesTransfered =
                                        currentIrpStack->Parameters
                                            .DeviceIoControl.OutputBufferLength;
                                  }
                                  ...
                                  cdaudioDataOut->LastTrack =
                                      ...
                                      ((int)*(Toc + 19) & 15);
                                  tracksOnCd =
                                      ((int)cdaudioDataOut->LastTrack -
                                       (int)cdaudioDataOut->FirstTrack) +
                                      1;
                                  dataLength =
                                      (unsigned long)((
                                          long)(&((CDROM_TOC *)0)
                                                     ->TrackData[tracksOnCd])) -
                                      2UL;
                                  cdaudioDataOut->Length[0] =
                                      (unsigned char)(dataLength >> 8);
                                  cdaudioDataOut->Length[1] =
                                      (unsigned char)(dataLength & 255UL);
                                  tracksInBuffer =
                                      currentIrpStack->Parameters
                                          .DeviceIoControl.OutputBufferLength -
                                      (unsigned long)((
                                ...
                                {
                                  deviceExtension->PlayActive = 0;
                                  tmp___3 = CdAudioSendToNextDriver(
                                      DeviceObject, Irp);
                                }
                                  return (tmp___3);
                                  goto switch_4_break;
                                switch_4_exp_3: /* CIL Label */
                                  ...
                                  if (currentIrpStack->Parameters
                                      ...
                                      (ULONG)sizeof(CDROM_PLAY_AUDIO_MSF)) {
                                    status = -1073741820L;
                                    Irp->IoStatus.Information = 0;
                                    goto switch_4_break;
                                  } else {
                                  }
                                  {
                                    ...
                                    cdb->NEC_PLAY_AUDIO.Minute =
                                        ((int)inputBuffer->StartingM / 10
                                         << 4) +
                                        (int)inputBuffer->StartingM % 10;
                                    cdb->NEC_PLAY_AUDIO.Second =
                                        ((int)inputBuffer->StartingS / 10
                                         << 4) +
                                        (int)inputBuffer->StartingS % 10;
                                    cdb->NEC_PLAY_AUDIO.Frame =
                                        ((int)inputBuffer->StartingF / 10
                                         << 4) +
                                        (int)inputBuffer->StartingF % 10;
                                    cdb->NEC_PLAY_AUDIO.Control = 64;
                                    status = SendSrbSynchronous(
                                        deviceExtension, &srb, (void *)0, 0);
                                  }
                                  if (status >= 0L) {
                                    {
                                      ...
                                      cdb->NEC_PLAY_AUDIO.Minute =
                                          ((int)inputBuffer->EndingM / 10
                                           << 4) +
                                          (int)inputBuffer->EndingM % 10;
                                      cdb->NEC_PLAY_AUDIO.Second =
                                          ((int)inputBuffer->EndingS / 10
                                           << 4) +
                                          (int)inputBuffer->EndingS % 10;
                                      cdb->NEC_PLAY_AUDIO.Frame =
                                          ((int)inputBuffer->EndingF / 10
                                           << 4) +
                                          (int)inputBuffer->EndingF % 10;
                                      cdb->NEC_PLAY_AUDIO.Control = 64;
                                      status = SendSrbSynchronous(
                                ...
                                switch_4_exp_4: /* CIL Label */
                                  ...
                                  if (currentIrpStack->Parameters
                                          .DeviceIoControl.InputBufferLength <
                                      (ULONG)sizeof(CDROM_SEEK_AUDIO_MSF)) {
                                    status = -1073741820L;
                                    Irp->IoStatus.Information = 0;
                                    goto switch_4_break;
                                  } else {
                                  }
                                  {
                                    ...
                                    cdb->NEC_SEEK_AUDIO.Minute =
                                        ((int)inputBuffer___0->M / 10 << 4) +
                                        (int)inputBuffer___0->M % 10;
                                    cdb->NEC_SEEK_AUDIO.Second =
                                        ((int)inputBuffer___0->S / 10 << 4) +
                                        (int)inputBuffer___0->S % 10;
                                    cdb->NEC_SEEK_AUDIO.Frame =
                                        ((int)inputBuffer___0->F / 10 << 4) +
                                        (int)inputBuffer___0->F % 10;
                                ...
                                switch_4_exp_7 : /* CIL Label */
                                {
                                  ...
                                  tmp___4 =
                                      ExAllocatePoolWithTag(4, 10, 541156419UL);
                                  SubQPtr = tmp___4;
                                }
                                  if (currentIrpStack->Parameters
                                          .DeviceIoControl.OutputBufferLength <
                                      (ULONG)sizeof(SUB_Q_CURRENT_POSITION)) {
                                    status = -1073741789L;
                                    Irp->IoStatus.Information = 0;
                                    if (SubQPtr) {
                                      {
                                  ...
                                  { memset(SubQPtr, 0, 10); }
                                  if ((int)((struct _CDROM_SUB_Q_DATA_FORMAT *)
                                                userPtr)
                                          ->Format != 1) {
                                    {
                                      /*                                 ExFreePool(SubQPtr);
                                ...
                                NECSeek : {
                                  ...
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, SubQPtr, 10);
                                }
                                  if (status >= 0L) {
                                    goto _L;
                                  } else {
                                ...
                                {
                                  tmp___6 = CdAudioSendToNextDriver(
                                      DeviceObject, Irp);
                                }
                                  return (tmp___6);
                                  goto switch_4_break;
...
NTSTATUS CdAudioPioneerDeviceControl(PDEVICE_OBJECT DeviceObject, PIRP Irp) {
  ...
  PioneerRestart : { memset(cdb, 0, 12); }
    if (currentIrpStack->Parameters.DeviceIoControl.IoControlCode ==
        ((2 << 16) | (1 << 14))) {
                          ...
                          if (currentIrpStack->Parameters.DeviceIoControl
                          ...
                          } else {
                            {
                              ...
                              switch_6_exp_13: /* CIL Label */;
                                ...
                                {
                                  tmp___0 = ExAllocatePoolWithTag(
                                      4, sizeof(CDROM_TOC), 541156419UL);
                                  Toc = (UCHAR *)tmp___0;
                                }
                                if ((unsigned int)Toc ==
                                    (unsigned int)((void *)0)) {
                                ...
                                cdaudioDataOut->LastTrack =
                                    (((int)*(Toc + 1) & 240) >> 4) * 10 +
                                    ((int)*(Toc + 1) & 15);
                                tracksOnCd = ((int)cdaudioDataOut->LastTrack -
                                              (int)cdaudioDataOut->FirstTrack) +
                                             1;
                                dataLength =
                                    (unsigned long)((
                              ...
                              switch_6_exp_19 : /* CIL Label */
                              {
                                userPtr = Irp->AssociatedIrp.SystemBuffer;
                                tmp___5 =
                                    ExAllocatePoolWithTag(4, 9, 541156419UL);
                                SubQPtr = tmp___5;
                              }
                                if (currentIrpStack->Parameters.DeviceIoControl
                                        .OutputBufferLength <
                                ...
                                if (status >= 0L) {
                                  ...
                                  userPtr->ADR = 0;
                                  userPtr->TrackNumber =
                                      (((int)*(SubQPtr + 1) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 1) & 15);
                                  userPtr->IndexNumber =
                                      (((int)*(SubQPtr + 2) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 2) & 15);
                                  userPtr->AbsoluteAddress[0] = 0;
                                  userPtr->AbsoluteAddress[1] =
                                      (((int)*(SubQPtr + 6) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 6) & 15);
                                  userPtr->AbsoluteAddress[2] =
                                      (((int)*(SubQPtr + 7) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 7) & 15);
                                  userPtr->AbsoluteAddress[3] =
                                      (((int)*(SubQPtr + 8) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 8) & 15);
                                  userPtr->TrackRelativeAddress[0] = 0;
                                  userPtr->TrackRelativeAddress[1] =
                                      (((int)*(SubQPtr + 3) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 3) & 15);
                                  userPtr->TrackRelativeAddress[2] =
                                      (((int)*(SubQPtr + 4) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 4) & 15);
                                  userPtr->TrackRelativeAddress[3] =
                                      (((int)*(SubQPtr + 5) & 240) >> 4) * 10 +
                                      ((int)*(SubQPtr + 5) & 15);
                                  Irp->IoStatus.Information =
                                      sizeof(SUB_Q_CURRENT_POSITION);
                                } else {
                            ...
                            } else {
                              {
                                    ...
                                    while_14_continue: /* CIL Label */;
                                      ...
                                      cdaudioDataOut->TrackData[i].Address[1] =
                                          (((int)*(Toc + (i * 4UL + 13UL)) &
                                           ...
                                           4) *
                                              10 +
                                          ((int)*(Toc + (i * 4UL + 13UL)) & 15);
                                      cdaudioDataOut->TrackData[i].Address[2] =
                                          (((int)*(Toc + (i * 4UL + 14UL)) &
                                            240) >>
                                           4) *
                                              10 +
                                          ((int)*(Toc + (i * 4UL + 14UL)) & 15);
                                      cdaudioDataOut->TrackData[i].Address[3] =
                                          (((int)*(Toc + (i * 4UL + 15UL)) &
                                            240) >>
                                           4) *
                                              10 +
                                          ((int)*(Toc + (i * 4UL + 15UL)) & 15);
                                      i += 1UL;
                                    }
                                ...
                                switch_13_exp_28 : /* CIL Label */
                                {
                                  ...
                                  }
                                  {
                                    ...
                                    cdb->CDB10.LogicalBlockByte3 =
                                        ((int)inputBuffer->EndingM / 10 << 4) +
                                        (int)inputBuffer->EndingM % 10;
                                    cdb->CDB10.Reserved2 =
                                        ((int)inputBuffer->EndingS / 10 << 4) +
                                        (int)inputBuffer->EndingS % 10;
                                    cdb->CDB10.TransferBlocksMsb =
                                        ((int)inputBuffer->EndingF / 10 << 4) +
                                        (int)inputBuffer->EndingF % 10;
                                    status = SendSrbSynchronous(
                                        deviceExtension, &srb, (void *)0, 0);
                                  }
                                ...
                                switch_13_exp_32 : /* CIL Label */
                                {
                                  ...
                                  }
                                  {
                                    ...
                                    cdb->CDB6GENERIC.CommandUniqueBytes[2] = 10;
                                    status = SendSrbSynchronous(
                                        deviceExtension, &srb, SubQPtr___0, 10);
                                  }
                                  if (status >= 0L) {
                                    userPtr->Header.Reserved = 0;
                                    if ((int)deviceExtension->Paused == 1) {
                                    ...
                                    userPtr->ADR = 0;
                                    userPtr->TrackNumber =
                                        (((int)*(SubQPtr___0 + 2) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 2) & 15);
                                    userPtr->IndexNumber =
                                        (((int)*(SubQPtr___0 + 3) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 3) & 15);
                                    userPtr->AbsoluteAddress[0] = 0;
                                    userPtr->AbsoluteAddress[1] =
                                        (((int)*(SubQPtr___0 + 7) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 7) & 15);
                                    userPtr->AbsoluteAddress[2] =
                                        (((int)*(SubQPtr___0 + 8) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 8) & 15);
                                    userPtr->AbsoluteAddress[3] =
                                        (((int)*(SubQPtr___0 + 9) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 9) & 15);
                                    userPtr->TrackRelativeAddress[0] = 0;
                                    userPtr->TrackRelativeAddress[1] =
                                        (((int)*(SubQPtr___0 + 4) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 4) & 15);
                                    userPtr->TrackRelativeAddress[2] =
                                        (((int)*(SubQPtr___0 + 5) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 5) & 15);
                                    userPtr->TrackRelativeAddress[3] =
                                        (((int)*(SubQPtr___0 + 6) & 240) >> 4) *
                                            10 +
                                        ((int)*(SubQPtr___0 + 6) & 15);
                                    Irp->IoStatus.Information =
                                        sizeof(SUB_Q_CURRENT_POSITION);
                                  } else {
                                    Irp->IoStatus.Information = 0;
...
NTSTATUS CdAudioHitachiDeviceControl(PDEVICE_OBJECT DeviceObject, PIRP Irp) {
...

  {
    ...
    cdaudioDataOut = Irp->AssociatedIrp.SystemBuffer;
    cdb = (union _HITACHICDB *)(srb.Cdb);
  HitachiRestart : { memset(cdb, 0, 12); }
    if (currentIrpStack->Parameters.DeviceIoControl.IoControlCode ==
        ((2 << 16) | (1 << 14))) {
                          ...
                          if (currentIrpStack->Parameters.DeviceIoControl
                          ...
                          } else {
                            {
                              ...
                              switch_15_exp_38: /* CIL Label */;
                                ...
                                {
                                  cdb->READ_DISC_INFO.AllocationLength[0] =
                                      sizeof(CDROM_TOC) >> 8;
                                  cdb->READ_DISC_INFO.AllocationLength[1] =
                                      sizeof(CDROM_TOC) & 255U;
                                  srb.TimeOutValue = 10;
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, Toc,
                                      sizeof(CDROM_TOC));
                                ...
                                if ((int)deviceExtension->Active == 6) {
                                  ...
                                  dataLength___0 =
                                      ...
                                      2UL;
                                  cdaudioDataOut->Length[0] =
                                      (unsigned char)(dataLength___0 >> 8);
                                  cdaudioDataOut->Length[1] =
                                      (unsigned char)(dataLength___0 & 255UL);
                                  tracksInBuffer___0 =
                                      currentIrpStack->Parameters
                                          .DeviceIoControl.OutputBufferLength -
                                      (unsigned long)((
                              ...
                              switch_15_exp_40: /* CIL Label */
                                ...
                                }
                                {
                                  ...
                                  cdb->PLAY_AUDIO.StartingM =
                                      inputBuffer->StartingM;
                                  cdb->PLAY_AUDIO.StartingS =
                                      inputBuffer->StartingS;
                                  cdb->PLAY_AUDIO.StartingF =
                                      inputBuffer->StartingF;
                                  cdb->PLAY_AUDIO.EndingM =
                                      inputBuffer->EndingM;
                                  cdb->PLAY_AUDIO.EndingS =
                                      inputBuffer->EndingS;
                                  cdb->PLAY_AUDIO.EndingF =
                                      inputBuffer->EndingF;
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, (void *)0, 0);
                                }
                              ...
                              {
                                tmp___2 =
                                    ExAllocatePoolWithTag(4, 3, 541156419UL);
                                PausePos = tmp___2;
                                Irp->IoStatus.Information = 0;
                              }
                                if ((unsigned int)PausePos ==
                                    (unsigned int)((void *)0)) {
                                  status = -1073741670L;
                                  goto SetStatusAndReturn;
                                } else {
                                }
                                {
                                  ...
                                  cdb->PAUSE_AUDIO.OperationCode = 225;
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, PausePos, 3);
                                  deviceExtension->Paused = 1;
                              ...
                              {
                                userPtr = Irp->AssociatedIrp.SystemBuffer;
                                tmp___3 = ExAllocatePoolWithTag(
                                    4, sizeof(SUB_Q_CHANNEL_DATA), 541156419UL);
                                SubQPtr = tmp___3;
                              }
                                if (currentIrpStack->Parameters.DeviceIoControl
                                        .OutputBufferLength <
                              ...
                              {
                                tmp___4 =
                                    ExAllocatePoolWithTag(4, 1, 541156419UL);
                                EjectStatus = tmp___4;
                                Irp->IoStatus.Information = 0;
                              }
                                if ((unsigned int)EjectStatus ==
                                    (unsigned int)((void *)0)) {
                                  status = -1073741670L;
                                  goto SetStatusAndReturn;
                                } else {
                                }
                                {
                                  ...
                                  cdb->EJECT.Eject = 1;
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, EjectStatus, 1);
                                }
                                if (status >= 0L) {
                                  deviceExtension->Paused = 0;
                                  deviceExtension->PausedM = 0;
                      ...
                      if (currentIrpStack->Parameters.DeviceIoControl
                      ...
                      } else {
                        {
                          ...
                          switch_18_exp_50 : /* CIL Label */
                          {
                            ...
                            {
                              tmp___0 = ExAllocatePoolWithTag(
                                  4, sizeof(READ_CAPACITY_DATA), 541156419UL);
                              lastSession = tmp___0;
                            }
                            if ((unsigned int)lastSession ==
                                (unsigned int)((void *)0)) {
                              status = -1073741670L;
                              Irp->IoStatus.Information = 0;
                              goto SetStatusAndReturn;
                            ...
                            {
                              memset(lastSession, 0,
                                     sizeof(READ_CAPACITY_DATA));
                              srb.CdbLength = 10;
                              cdb->CDB10.OperationCode = 38;
                              srb.TimeOutValue = 10;
                              status = SendSrbSynchronous(
                                  deviceExtension, &srb, lastSession,
                                  sizeof(READ_CAPACITY_DATA));
                            }
                            if (!(status >= 0L)) {
                              {
                            ...
                            }
                            {
                              ...
                              memset(cdaudioDataOut, 0, bytesTransfered);
                              cdaudioDataOut->Length[0] =
                                  (unsigned char)((bytesTransfered - 2UL) >> 8);
                              cdaudioDataOut->Length[1] =
                                  (unsigned char)((bytesTransfered - 2UL) &
                                                  255UL);
                            }
                          ...
                          switch_18_exp_51: /* CIL Label */;
                            ...
                            }
                            {
                              ...
                              srb.CdbLength = 10;
                              status =
                                  SendSrbSynchronous(deviceExtension, &srb, Toc,
                                                     sizeof(CDROM_TOC));
                            }
                            if (!(status >= 0L)) {
                              if (status != -1073741764L) {
                          ...
                          switch_18_exp_52 : /* CIL Label */
                          {
                            userPtr = Irp->AssociatedIrp.SystemBuffer;
                            tmp___3 = ExAllocatePoolWithTag(
                                4, sizeof(SUB_Q_CURRENT_POSITION), 541156419UL);
                            SubQPtr = tmp___3;
                          }
                            if (currentIrpStack->Parameters.DeviceIoControl
                                    .OutputBufferLength <
                          ...
                          switch_18_exp_53: /* CIL Label */
                            ...
                            if ((int)inputBuffer->StartingM ==
                                (int)inputBuffer->EndingM) {
                              if ((int)inputBuffer->StartingS ==
                                  (int)inputBuffer->EndingS) {
                                if ((int)inputBuffer->StartingF ==
                                    (int)inputBuffer->EndingF) {
                            ...
                            if (status >= 0L) {
                              if ((int)cdb->PLAY_AUDIO_MSF.OperationCode ==
                                  71) {
                                deviceExtension->PlayActive = 1;
                              } else {
                              }
                          ...
                          switch_18_exp_54: /* CIL Label */
                            ...
                            {
                              destblock =
                                  (((unsigned long)inputBuffer___0->M * 60UL +
                                    (unsigned long)inputBuffer___0->S) *
                                       75UL +
                                   (unsigned long)inputBuffer___0->F) -
                                  150UL;
                              srb.CdbLength = 10;
                              srb.TimeOutValue = 10;
                              cdb->SEEK.OperationCode = 43;
                              cdb->SEEK.LogicalBlockAddress[0] =
                                  (int)((unsigned char)(destblock >> 24)) & 255;
                              cdb->SEEK.LogicalBlockAddress[1] =
                                  (int)((unsigned char)(destblock >> 16)) & 255;
                              cdb->SEEK.LogicalBlockAddress[2] =
                                  (int)((unsigned char)(destblock >> 8)) & 255;
                              cdb->SEEK.LogicalBlockAddress[3] =
                                  (unsigned char)(destblock & 255UL);
                              status = SendSrbSynchronous(deviceExtension, &srb,
                                                          (void *)0, 0);
                            }
                            if (!(status >= 0L)) {
                          ...
                          } else {
                            {
                              ...
                              switch_20_exp_60: /* CIL Label */;
                                ...
                                }
                                {
                                  ...
                                  cdb->READ_TOC.Msf = 1;
                                  cdb->READ_TOC.AllocationLength[0] =
                                      sizeof(CDROM_TOC) >> 8;
                                  cdb->READ_TOC.AllocationLength[1] =
                                      sizeof(CDROM_TOC) & 255U;
                                  srb.TimeOutValue = 10;
                                  srb.CdbLength = 10;
                                  status = SendSrbSynchronous(
                              ...
                              switch_20_exp_66 : /* CIL Label */
                              {
                                ...
                                }
                                {
                                  ...
                                  cdb->SUBCHANNEL.AllocationLength[1] =
                                      sizeof(SUB_Q_CHANNEL_DATA);
                                  status = SendSrbSynchronous(
                                      deviceExtension, &srb, SubQPtr___0,
                                      sizeof(SUB_Q_CHANNEL_DATA));
                                }
                                if (status >= 0L) {
                                  userPtr->Header.Reserved = 0;
    ...
    if ((long)myStatus >= 0L) {
      {
        HpCdrProcessLastSession(
            (struct _CDROM_TOC *)Irp->AssociatedIrp.SystemBuffer);
      }
    } else {
    }
    return (myStatus);
  ...
  {
    {
      /*   KeInitializeEvent(& event, 0, 0); */ /* INLINED */
      deviceExtension =
          (struct _CD_DEVICE_EXTENSION *)DeviceObject->DeviceExtension;
      irpSp = Irp->Tail.Overlay.__annonCompField17.__annonCompField16
                  .CurrentStackLocation;
      nextIrpSp = Irp->Tail.Overlay.__annonCompField17.__annonCompField16
                      .CurrentStackLocation -
...
int main(void) {
  ...
  irp.Tail.Overlay.__annonCompField17.__annonCompField16.CurrentStackLocation =
      malloc(sizeof(IO_STACK_LOCATION));
