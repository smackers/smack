...
typedef struct _SYNCHRONIZED_DISCONNECT_CONTEXT
    *PSYNCHRONIZED_DISCONNECT_CONTEXT;
...
NTSTATUS RtlDeleteRegistryValue(ULONG RelativeTo, PCWSTR Path,
                                PCWSTR ValueName);
extern NTSTATUS RtlIntegerToUnicodeString(ULONG Value, ULONG Base,
                                          PUNICODE_STRING String);
extern NTSTATUS RtlUnicodeStringToInteger(PUNICODE_STRING String, ULONG Base,
                                          PULONG Value);
...
#pragma warning(disable : 4103)
#pragma warning(disable : 4103)
extern void KeInitializeDpc(PRKDPC Dpc,
                            void (*DeferredRoutine)(struct _KDPC *Dpc,
                                                    PVOID DeferredContext,
                                                    PVOID SystemArgument1,
                                                    PVOID SystemArgument2),
                            PVOID DeferredContext);
...
IoReportResourceUsage(PUNICODE_STRING DriverClassName,
                      PDRIVER_OBJECT DriverObject, PCM_RESOURCE_LIST DriverList,
                      ULONG DriverListSize, PDEVICE_OBJECT DeviceObject,
                      PCM_RESOURCE_LIST DeviceList, ULONG DeviceListSize,
                      BOOLEAN OverrideConflict, PBOOLEAN ConflictDetected);
void IoSetHardErrorOrVerifyDevice(PIRP Irp, PDEVICE_OBJECT DeviceObject);
extern void IoInitializeRemoveLockEx(PIO_REMOVE_LOCK Lock, ULONG AllocateTag,
                                     ULONG MaxLockedMinutes,
                                     ULONG HighWatermark, ULONG RemlockSize);
NTSTATUS IoAcquireRemoveLockEx(PIO_REMOVE_LOCK RemoveLock, PVOID Tag,
                               PCSTR File, ULONG Line, ULONG RemlockSize);
extern void IoReleaseRemoveLockEx(PIO_REMOVE_LOCK RemoveLock, PVOID Tag,
                                  ULONG RemlockSize);
...
extern NTSTATUS PoRequestPowerIrp(
    PDEVICE_OBJECT DeviceObject, UCHAR MinorFunction, POWER_STATE PowerState,
    void (*CompletionFunction)(PDEVICE_OBJECT DeviceObject, UCHAR MinorFunction,
...
extern NTSTATUS ZwSetValueKey(HANDLE KeyHandle, PUNICODE_STRING ValueName,
...
NTSTATUS PptPnpAddDevice(PDRIVER_OBJECT pDriverObject,
...
void PptLogError(PDRIVER_OBJECT DriverObject, PDEVICE_OBJECT DeviceObject,
                 PHYSICAL_ADDRESS P1, PHYSICAL_ADDRESS P2, ULONG SequenceNumber,
                 UCHAR MajorFunctionCode, UCHAR RetryCount,
                 ULONG UniqueErrorValue, NTSTATUS FinalStatus,
...
void PptFreePortDpc(PKDPC Dpc, PVOID Extension, PVOID SystemArgument1,
                    PVOID SystemArgument2);
...
NTSTATUS PptDispatchInternalDeviceControl(PDEVICE_OBJECT DeviceObject,
                                          PIRP Irp);
...
PWSTR PptGetPortNameFromPhysicalDeviceObject(
    PDEVICE_OBJECT PhysicalDeviceObject);
PVOID PptSetCancelRoutine(
    PIRP Irp, void (*CancelRoutine)(struct _DEVICE_OBJECT *DeviceObject,
                                    struct _IRP *Irp));
...
void PptDebugDumpResourceRequirementsList(
...
#pragma warning(default : 4200)
#pragma once
PCHAR PnpIrpName[25] = {"IRP_MN_START_DEVICE                 0x00",
...
void PptLogError(PDRIVER_OBJECT DriverObject, PDEVICE_OBJECT DeviceObject,
  ...
  {
    {}
    if ((unsigned int)((CHAR *)DeviceObject) !=
        (unsigned int)((CHAR *)((void *)0))) {
    ...
    if (P2.__annonCompField1.LowPart != 0UL) {
      DumpToAllocate =
          (int)DumpToAllocate + (int)((short)sizeof(PHYSICAL_ADDRESS));
    } else {
    ...
    }
    {
      tmp = IoAllocateErrorLogEntry(
          ObjectToUse, (unsigned char)(sizeof(IO_ERROR_LOG_PACKET) +
                                       (unsigned int)DumpToAllocate));
      ErrorLogEntry = tmp;
    }
    if (!ErrorLogEntry) {
      return;
      ...
      while_17_continue: /* CIL Label */;
        ...
        }
        {
          ...
          while_18_continue: /* CIL Label */;
            if (!((unsigned int)Extension->IsrList.Flink ==
                  (unsigned int)(&Extension->IsrList))) {
            ...
            }
            {
              ...
              Entry = (ISR_LIST_ENTRY *)((CHAR *)Head -
                                         (unsigned long)(&((ISR_LIST_ENTRY *)0)
                                                              ->ListEntry));
...

  {
    ...
    }
    {
      ...
      while_19_continue: /* CIL Label */;
        ...
        _EX_Blink->Flink = _EX_Flink;
        _EX_Flink->Blink = _EX_Blink;
        node = (REMOVAL_RELATIONS_LIST_ENTRY
                    *)((CHAR *)thisListEntry -
...
NTSTATUS
PptAddPptRemovalRelation(PDEVICE_EXTENSION Extension,
  ...
  {
    {
      tmp = ExAllocatePoolWithTag(1, sizeof(REMOVAL_RELATIONS_LIST_ENTRY),
                                  1349673296UL);
      node = tmp;
    }
    {}
    ...
    }
    {
      ...
      tmp___0 = ExAllocatePoolWithTag(
          1, (PptRemovalRelations->DeviceName)->MaximumLength, 1349673296UL);
...
NTSTATUS
PptRemovePptRemovalRelation(PDEVICE_EXTENSION Extension,
                            PPARPORT_REMOVAL_RELATIONS PptRemovalRelations) {
...
void PptDumpPptRemovalRelationsStruct(
    PPARPORT_REMOVAL_RELATIONS PptRemovalRelations) {
                                ...
                                if (IrpSp->Parameters.DeviceIoControl
                                ...
                                } else {
                                  {
                                    ...
                                    switch_41_exp_0: /* CIL Label */;
                                      ...
                                      if (IrpSp->Parameters.DeviceIoControl
                                      ...
                                      } else {
                                        {
                                          ...
                                          PptDumpRemovalRelationsList(
                                              Extension);
                                          PptAddPptRemovalRelation(
                                              Extension, removalRelations);
                                          PptDumpRemovalRelationsList(
                                              Extension);
                                        }
                                        {}
                                      ...
                                      {
                                        Irp->IoStatus.__annonCompField4.Status =
                                            Status;
                                        myStatus = Status;
                                      ...
                                      if (IrpSp->Parameters.DeviceIoControl
                                      ...
                                      } else {
                                        {
                                          ...
                                          PptRemovePptRemovalRelation(
                                              Extension, removalRelations___0);
                                          PptDumpRemovalRelationsList(
                                              Extension);
                                        }
                                        {}
                                    ...
                                    switch_41_exp_3 : /* CIL Label */
                                    {
                                      ...
                                      if (Irp->Cancel) {
                                        ...
                                        if (SyncContext.NewCount) {
                                          ...
                                          Extension->WmiPortAllocFreeCounts
                                              .PortAllocates += 1UL;
                                          Status = 0L;
                                        }
                                      }
                                    ...
                                    switch_41_exp_7: /* CIL Label */;
                                      ...
                                      if (IrpSp->Parameters.DeviceIoControl
                                        ...
                                        MorePortInfo =
                                            Irp->AssociatedIrp.SystemBuffer;
                                        MorePortInfo->InterfaceType =
                                            Extension->InterfaceType;
                                        MorePortInfo->BusNumber =
                                            Extension->BusNumber;
                                        ...
                                        if (Extension->InterruptRefCount) {
                                          {
                                            /*                                       IoReleaseCancelSpinLock(CancelIrql);
                                             */ /* INLINED */
                                            DisconnectContext.Extension =
                                                Extension;
                                            DisconnectContext.IsrInfo = IsrInfo;
                                            tmp___1 = KeSynchronizeExecution(
                                                Extension->InterruptObject,
                                    ...
                                    switch_41_exp_10: /* CIL Label */;
                                      ...
                                      if (IrpSp->Parameters.DeviceIoControl
                                              .InputBufferLength <
                                          (ULONG)sizeof(PARALLEL_CHIP_MODE)) {
                                        Status = -1073741789L;
                                      } else {
                                        {} {
                                          Status = PptSetChipMode(
                                              Extension,
                                              ((struct _PARALLEL_CHIP_MODE *)Irp
  ...
  {
    {
      ...
      tmp = ExAllocatePoolWithTag(1, identifierString.MaximumLength,
                                  1349673296UL);
    ...
    if (Status >= 0L) {
      {
        tmp___0 =
            RtlCompareUnicodeString(&identifierString, &necR98Identifier, 0);
      }
      if (tmp___0 == 0L) {
        goto _L;
      } else {
        {
          tmp___1 =
              RtlCompareUnicodeString(&identifierString, &necR98JIdentifier, 0);
        }
        if (tmp___1 == 0L) {
        _L : /* CIL Label */
        {}
...
#pragma once
BOOLEAN PptCheckIfStl1284_3(PDEVICE_EXTENSION DeviceExtension,
                            ULONG ulDaisyIndex, BOOLEAN bNoStrobe);
BOOLEAN PptCheckIfNon1284_3Present(PDEVICE_EXTENSION Extension);
BOOLEAN PptCheckIfStlProductId(PDEVICE_EXTENSION DeviceExtension,
                               ULONG ulDaisyIndex);
ULONG PptInitiate1284_3(PVOID Extension) {
  ULONG deviceCount1;
  ULONG deviceCount2;
          ...
          if ((ULONG)DeviceID < Extension->PnpInfo.Ieee1284_3DeviceCount) {
            i = 0;
            {
              ...
              while_79_continue: /* CIL Label */;
                ...
                {
                  success = PptSend1284_3Command(
                      Extension, (unsigned char)(224 | (int)DeviceID));
                  KeStallExecutionProcessor(5);
                  i = (UCHAR)((int)i + 1);
                }
              }
        ...
        if (((int)status & 48) == 48) {
          { KeStallExecutionProcessor(Delay); }
          {
            ...
            while_95_continue: /* CIL Label */;
              ...
              {
                WRITE_PORT_UCHAR(CurrentControl,
                                 (unsigned char)((int)newvalue & -2));
                WRITE_PORT_UCHAR(CurrentControl,
                                 (unsigned char)((int)newvalue | 1));
                KeStallExecutionProcessor(Delay);
                WRITE_PORT_UCHAR(CurrentControl,
                                 (unsigned char)((int)newvalue & -2));
                KeStallExecutionProcessor(Delay);
          ...
          if (number) {
            ...
            }
            {
              ...
              while_96_continue: /* CIL Label */;
                ...
                {
                  tmp___0 = PptCheckIfStl1284_3(DeviceExtension, idx,
                                                bStlNon1284_3Found);
                }
                if (1 == (int)tmp___0) {
                  goto __Cont;
        ...
        if (((int)status & 48) == 48) {
          {
            ...
            WRITE_PORT_UCHAR(CurrentPort,
                             (unsigned char)(136UL | ulDaisyIndex));
            KeStallExecutionProcessor(Delay);
          }
          if (ulDaisyIndex) {
            if ((int)bNoStrobe == 0) {
          ...
          bReturnValue = 1;
          {
            ...
            while_97_continue: /* CIL Label */;
              ...
              }
              {
                KeStallExecutionProcessor(Delay);
                WRITE_PORT_UCHAR(CurrentPort,
                                 (unsigned char)(128UL | ulDaisyIndex));
                KeStallExecutionProcessor(Delay);
                WRITE_PORT_UCHAR(CurrentPort,
                                 (unsigned char)(136UL | ulDaisyIndex));
                KeStallExecutionProcessor(Delay);
        ...
        if (((int)status & 48) == 48) {
          {
            ...
            ucProdIdLoByte =
                (int)ucProdIdLoByteHiNibble | (int)ucProdIdLoByteLoNibble;
            KeStallExecutionProcessor(Delay);
            WRITE_PORT_UCHAR(CurrentControl,
                             (unsigned char)((int)newvalue & -2));
            WRITE_PORT_UCHAR(CurrentControl,
            ...
            ucProdIdHiByte =
                (int)ucProdIdHiByteHiNibble | (int)ucProdIdHiByteLoNibble;
            KeStallExecutionProcessor(Delay);
            WRITE_PORT_UCHAR(CurrentControl,
                             (unsigned char)((int)newvalue & -2));
            WRITE_PORT_UCHAR(CurrentControl,
    ...
    if (((int)ecr & 3) == 1) {
      ...
      limitCount = 0;
      {
        ...
        while_148_continue: /* CIL Label */;
          ...
          {
            WRITE_PORT_UCHAR(wPortDFIFO,
                             (unsigned char)((int)writeFifoDepth & 255));
...
void PptDetermineFifoWidth(PDEVICE_EXTENSION Extension) {
...

  {
    {} {
      ...
      Extension->PnpInfo.FifoWidth =
          (unsigned long)(((int)bConfigA & 112) >> 4);
      WRITE_PORT_UCHAR(wPortECR, 20);
    }
    return;
  }
...
NTSTATUS PptFindNatChip(PDEVICE_EXTENSION Extension) {
...

  {
    ...
    }
    {
      ...
      ResourcesSize = (ULONG)sizeof(CM_RESOURCE_LIST) +
                      (ResourceDescriptorCount - 1UL) *
    ...
    }
    {
      Status = IoReportResourceUsage(
          (void *)0, Extension->DriverObject, Resources, sizeof(Resources),
                      ...
                      if ((int)cr == 144) {
                        ...
                        if ((int)cr == 176) {
                          ...
                          _L___0 : /* CIL Label */
                          {
                            ...
                            if ((unsigned int)Extension->PortInfo.Controller ==
                                (unsigned int)AddrList[Port]) {
                              Extension->NationalChipFound = 1;
                            } else {
                            }
                          } else {
    ...
    }
    {
      Status = IoReportResourceUsage((void *)0, Extension->DriverObject,
                                     (void *)0, 0, Extension->DeviceObject,
                                     (void *)0, 0, 0, &Conflict);
    }
    {}
    return (Status);
...

  {
    ...
    i = 0;
    {
      ...
      while_182_continue: /* CIL Label */;
        ...
        Resources->List[0]
            .PartialResourceList.PartialDescriptors[i]
            .u.Port.Start.QuadPart = *(Addresses + i);
        Resources->List[0]
            .PartialResourceList.PartialDescriptors[i]
            .u.Port.Length = 2UL;
        i = (UCHAR)((int)i + 1);
...
#pragma once
struct _GUID const GUID_PARALLEL_DEVICE = {
    2549575408U, 63619, 4560, {175, 31, 0, 0, 248, 0, 132, 92}};
struct _GUID const GUID_PARCLASS_DEVICE = {
    2166343333U, 63272, 4560, {165, 55, 0, 0, 248, 117, 62, 209}};
...
#pragma warning(default : 4200)
#pragma once
NTSTATUS PptPnpFilterResourceRequirements(PDEVICE_OBJECT DeviceObject,
                                          PIRP Irp);
...
NTSTATUS PptPnpStartValidateResources(PDEVICE_OBJECT DeviceObject,
                                      BOOLEAN FoundPort, BOOLEAN FoundIrq,
                                      BOOLEAN FoundDma);
NTSTATUS PptPnpStartScanCmResourceList(PDEVICE_EXTENSION Extension, PIRP Irp,
                                       PBOOLEAN FoundPort, PBOOLEAN FoundIrq,
                                       PBOOLEAN FoundDma);
NTSTATUS
PptPnpPassThroughPnpIrpAndReleaseRemoveLock(PDEVICE_EXTENSION Extension,
                                            PIRP Irp);
...
void PptPnpFilterNukeIrqResourceDescriptorsFromAllLists(
    PIO_RESOURCE_REQUIREMENTS_LIST ResourceRequirementsList);
BOOLEAN PptPnpFilterExistsNonIrqResourceList(
    PIO_RESOURCE_REQUIREMENTS_LIST ResourceRequirementsList);
PVOID PptPnpFilterGetEndOfResourceRequirementsList(
    PIO_RESOURCE_REQUIREMENTS_LIST ResourceRequirementsList);
BOOLEAN PptPnpListContainsIrqResourceDescriptor(PIO_RESOURCE_LIST List);
void PptPnpFilterRemoveIrqResourceLists(
    PIO_RESOURCE_REQUIREMENTS_LIST ResourceRequirementsList);
...
NTSTATUS PptPnpStartScanPciCardCmResourceList(PDEVICE_EXTENSION Extension,
                                              PIRP Irp, PBOOLEAN FoundPort,
                                              PBOOLEAN FoundIrq,
                                              PBOOLEAN FoundDma) {
  NTSTATUS status;
  PIO_STACK_LOCATION irpStack;
                ...
                if (PartialResourceDescriptor->Type == 4) {
                ...
                } else {
                  {
                        ...
                        } else {
                          {
                            ...
                            switch_196_8: /* CIL Label */;
                              ...
                              Extension->PortInfo.Controller =
                                  (UCHAR *)((unsigned long)Extension->PortInfo
                                                .OriginalController.QuadPart);
                            ...
                            switch_196_4: /* CIL Label */;
                              ...
                              Extension->PnpInfo.EcpController =
                                  (UCHAR *)((unsigned long)Extension->PnpInfo
                    ...
                    switch_195_6: /* CIL Label */
                      Extension->BusNumber =
                          PartialResourceDescriptor->u.BusNumber.Start;
                      goto switch_195_break;
                        ...
                        if (__BLAST_NONDET == 8) {
                          ...
                          if (__BLAST_NONDET == 9) {
                          ...
                          } else {
                            {
                              ...
                              {
                                status = PptPnpFilterResourceRequirements(
                                    DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              switch_214_3 : /* CIL Label */
                              {
                                status = PptPnpQueryDeviceRelations(
                                    DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              ...
                              {
                                status =
                                    PptPnpQueryStopDevice(DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              switch_214_5 : /* CIL Label */
                              {
                                status =
                                    PptPnpCancelStopDevice(DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              ...
                              {
                                status =
                                    PptPnpQueryRemoveDevice(DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              switch_214_8 : /* CIL Label */
                              {
                                status =
                                    PptPnpCancelRemoveDevice(DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              ...
                              {
                                status =
                                    PptPnpSurpriseRemoval(DeviceObject, Irp);
                              }
                                goto switch_214_break;
                              } else {
      ...
      if (1 == (int)tmp) {
        {} {
          status = PptPnpStartScanPciCardCmResourceList(
              Extension, Irp, FoundPort, FoundIrq, FoundDma);
          isPci = 1;
        }
        goto targetExit;
      } else {
                            ...
                            if ((int)((KUSER_SHARED_DATA *const)4292804608U)
                              ...
                              if (PartialResourceDescriptor->u.Port.Start
                                ...
                                if (PartialResourceDescriptor->u.Port.Start
                                  ...
                                  Extension->PortInfo.Controller =
                                      (UCHAR
                                           *)((unsigned long)Extension->PortInfo
                                                  .OriginalController.QuadPart);
                                  Extension->AddressSpace =
                                      PartialResourceDescriptor->Flags;
      ...
      if (!extension->PortInfo.Controller) {
        {
          PptLogError(DeviceObject->DriverObject, DeviceObject,
                      extension->PortInfo.OriginalController, PhysicalZero, 0,
                      0, 0, 10, 0L, 4);
          status = -1073741709L;
        }
      } else {
...
NTSTATUS PptPnpFilterResourceRequirements(PDEVICE_OBJECT DeviceObject,
...

  {
    ...
    if (Irp->IoStatus.Information == 0UL) {
      IrpStack = Irp->Tail.Overlay.__annonCompField17.__annonCompField16
                     .CurrentStackLocation;
      pResourceRequirementsIn = IrpStack->Parameters.FilterResourceRequirements
        ...
        if (filterResourceMethod == 2) {
        ...
        } else {
          {
            ...
            switch_229_1: /* CIL Label */;
              {} {
                tmp = PptPnpFilterExistsNonIrqResourceList(
                    pResourceRequirementsIn);
              }
              if (tmp) {
                {} {
            ...
            switch_229_0: /* CIL Label */;
              {} {
                tmp___0 = PptPnpFilterExistsNonIrqResourceList(
                    pResourceRequirementsIn);
              }
              if (tmp___0) {
                {} {
...

  {
    ...
    curList = ResourceRequirementsList->List;
    {
      ...
      while_241_continue: /* CIL Label */;
        ...
        curList =
            (struct _IO_RESOURCE_LIST *)(curList->Descriptors + curList->Count);
        i += 1UL;
      }
...
void PptPnpFilterRemoveIrqResourceLists(
...

  {
    listCount = ResourceRequirementsList->AlternativeLists;
    {} {
      tmp = PptPnpFilterGetEndOfResourceRequirementsList(
      ...
      while_249_continue: /* CIL Label */;
        ...
        if (tmp___0) {
          ...
          nextList = (struct _IO_RESOURCE_LIST *)(curList->Descriptors +
                                                  curList->Count);
          bytesToMove =
              (long)(currentEndOfResourceRequirementsList - (CHAR *)nextList);
          if (bytesToMove > 0L) {
            {
              memmove(curList, nextList, bytesToMove);
              currentEndOfResourceRequirementsList -=
                  (CHAR *)nextList - (CHAR *)curList;
            }
          } else {
          }
          listCount -= 1UL;
                ...
                switch_261_3: /* CIL Label */;
                  ...
                  if (Irp->IoStatus.Information) {
                    ...
                    if (removalRelations) {
                      ...
                      myStatus = 0L;
                      Irp->IoStatus.Information =
                          (unsigned long)removalRelations;
                    } else {
                      {}
                    }
                  }
...
NTSTATUS PptPowerComplete(PDEVICE_OBJECT pDeviceObject, PIRP pIrp,
  ...
  {
    pIrpStack = pIrp->Tail.Overlay.__annonCompField17.__annonCompField16
                    .CurrentStackLocation;
            ...
            if (powerType == 1) {
              ...
              if (powerType == 0) {
                ...
                switch_276_1: /* CIL Label */;
                  if ((int)Extension->DeviceState <
                      (int)powerState.DeviceState) {

                  } else {
                    if ((int)powerState.DeviceState <
                        (int)Extension->DeviceState) {
                      {
                        PoSetPowerState(Extension->DeviceObject, powerType,
                                        powerState);
                      }
                ...
                switch_276_0: /* CIL Label */;
                  if ((int)Extension->SystemState <
                      (int)powerState.SystemState) {

                  } else {
                    if ((int)powerState.SystemState <
                        (int)Extension->SystemState) {
                      if (1 == (int)powerState.SystemState) {
                        {
                          powerState.DeviceState = 1;
                          PoRequestPowerIrp(Extension->DeviceObject, 2,
...
NTSTATUS PptDispatchPower(PDEVICE_OBJECT pDeviceObject, PIRP pIrp) {
...

  {
                ...
                switch_279_0: /* CIL Label */;
                  if ((int)Extension->SystemState <
                    ...
                    }
                    {
                      ...
                      PoRequestPowerIrp(Extension->DeviceObject, 2, powerState,
    ...
    {
      irpSp = pIrp->Tail.Overlay.__annonCompField17.__annonCompField16
                  .CurrentStackLocation;
      nextIrpSp = pIrp->Tail.Overlay.__annonCompField17.__annonCompField16
                      .CurrentStackLocation -
                  1;
      memcpy(nextIrpSp, irpSp,
             (long)(&((IO_STACK_LOCATION *)0)->CompletionRoutine));
    ...
    if (!(status >= 0L)) {
      ...
      if (hookit) {
        ...
        {
          irpSp___0 = pIrp->Tail.Overlay.__annonCompField17.__annonCompField16
                          .CurrentStackLocation -
                      1;
  ...
  {
    {
      ...
      defaultBreakOn = 0UL;
      tmp = ExAllocatePoolWithTag(
          1, (unsigned int)RegistryPath___0->Length + sizeof(WCHAR),
          1349673296UL);
      path = tmp;
    }
    if (!path) {
    ...
    }
    {
      ...
      *(path + (int)RegistryPath___0->Length / 2) = (unsigned short)0;
      ...
      Status = RtlQueryRegistryValues(2147483648U, path, paramTable, (void *)0,
                                      (void *)0);
    }
    if (!(Status >= 0L)) {
      PptDebugLevel = defaultDebugLevel;
...
NTSTATUS PptRegGetDeviceParameterDword(PDEVICE_OBJECT Pdo, PWSTR ParameterName,
...

  {
    ...
    }
    {
      ...
      status = RtlQueryRegistryValues(1073741824, hKey, queryTable, (void *)0,
                                      (void *)0);
    }
    if (!(status >= 0L)) {
  ...
  {
    {
      ...
      tmp = IoAcquireRemoveLockEx(removeLock, Irp, "util.c", 33,
                                  sizeof(IO_REMOVE_LOCK));
      status = tmp;
    }
    if (!(status >= 0L)) {
...

  {
    ...
    }
    {
      ...
      while_290_continue: /* CIL Label */;
        ...
        {
          status = ZwQueryValueKey(hKey, &valueName, 1, buffer, bufferLength,
                                   &resultLength);
        }
        if (status == -1073741789L) {
          if (buffer) {
    ...
    {
      memcpy(portName, (UCHAR *)buffer + buffer->DataOffset,
             buffer->DataLength);
      /*   ExFreePool(buffer); */ /* INLINED */
    }
    return (portName);
...

  {
    ...
    }
    {
      Status = IoConnectInterrupt(
          &Extension->InterruptObject, &PptInterruptService, Extension,
          (void *)0, Extension->InterruptVector, Extension->InterruptLevel,
    ...
    if (!(Status >= 0L)) {
      {
        PptLogError((Extension->DeviceObject)->DriverObject,
                    ...
                    Extension->PortInfo.OriginalController, PhysicalZero, 0, 0,
                    0, 14, Status, 20);
      }
      {}
    } else {
...
BOOLEAN PptSynchronizedIncrement(PVOID SyncContext) {

  {
    *(((struct _SYNCHRONIZED_COUNT_CONTEXT *)SyncContext)->Count) += 1L;
    ((struct _SYNCHRONIZED_COUNT_CONTEXT *)SyncContext)->NewCount =
        *(((struct _SYNCHRONIZED_COUNT_CONTEXT *)SyncContext)->Count);
    return (1);
  }
}
BOOLEAN PptSynchronizedDecrement(PVOID SyncContext) {
    ...
    Current = (DisconnectContext->Extension)->IsrList.Flink;
    {
      ...
      while_296_continue: /* CIL Label */;
        if ((unsigned int)Current !=
            (unsigned int)(&(DisconnectContext->Extension)->IsrList)) {

        } else {
          goto while_296_break;
        }
        ListEntry = (ISR_LIST_ENTRY *)((CHAR *)Current -
                                       (unsigned long)(&((ISR_LIST_ENTRY *)0)
                                                            ->ListEntry));
        if ((unsigned int)ListEntry->ServiceRoutine ==
            (unsigned int)ServiceRoutine) {
          if ((unsigned int)ListEntry->ServiceContext ==
              (unsigned int)ServiceContext) {
...
BOOLEAN PptTryAllocatePortAtInterruptLevel(PVOID Context) {

  {
    if (((struct _DEVICE_EXTENSION *)Context)->WorkQueueCount == -1L) {
      ...
      ((struct _DEVICE_EXTENSION *)Context)
          ->WmiPortAllocFreeCounts.PortAllocates += 1UL;
      return (1);
    } else {
      return (0);
    }
...
void PptFreePortFromInterruptLevel(PVOID Context) {

  {
    if (((struct _DEVICE_EXTENSION *)Context)->WorkQueueCount == 0L) {
      ...
      {
        KeInsertQueueDpc(&((struct _DEVICE_EXTENSION *)Context)->FreePortDpc,
                         (void *)0, (void *)0);
      }
    }
    return;
...

  {
    ...
    Current = DeviceExtension->IsrList.Flink;
    {
      ...
      while_298_continue: /* CIL Label */;
        if ((unsigned int)Current !=
            (unsigned int)(&DeviceExtension->IsrList)) {
        ...
        {
          IsrListEntry =
              (ISR_LIST_ENTRY *)((CHAR *)Current -
                                 (unsigned long)(&((ISR_LIST_ENTRY *)0)
                                                      ->ListEntry));
          tmp = (*(IsrListEntry->ServiceRoutine))(Interrupt,
                                                  IsrListEntry->ServiceContext);
        }
        if (tmp) {
          return (1);
...

  {
    ...
    Current = DeviceExtension->IsrList.Flink;
    {
      ...
      while_300_continue: /* CIL Label */;
        ...
        CheckEntry = (ISR_LIST_ENTRY *)((CHAR *)Current -
                                        (unsigned long)(&((ISR_LIST_ENTRY *)0)
                                                             ->ListEntry));
  ...
  {
    {
      tmp = InterlockedExchange((LONG *)((PVOID *)(&Irp->CancelRoutine)),
                                (long)((void *)CancelRoutine));
    }
    return ((void (*)(struct _DEVICE_OBJECT * DeviceObject, struct _IRP * Irp))(
        (void *)tmp));
  }
}
...

  {
    ...
    }
    {
      ...
      while_303_continue: /* CIL Label */;
        ...
        if ((End.QuadPart - Start.QuadPart) * (LONGLONG)tmp___0 >
            Wait.QuadPart) {
...

  {
    ...
    }
    {
      DeviceName->MaximumLength =
          (unsigned short)((unsigned int)(((int)uniDeviceString.Length +
                                           (int)uniBaseNameString.Length) +
                                          (int)uniPortNumberString.Length) +
  ...
  {
    {
      ...
      IoInitializeRemoveLockEx(&Extension->RemoveLock, 1349673296UL, 1, 10,
                               sizeof(IO_REMOVE_LOCK));
      ...
      bufferLength = (unsigned int)UniNameString->MaximumLength +
                     sizeof((unsigned short)0);
...
PDEVICE_OBJECT PptBuildDeviceObject(PDRIVER_OBJECT DriverObject,
...

  {
    ...
    {
      status = PptInitializeDeviceExtension(DriverObject, PhysicalDeviceObject,
                                            deviceObject, &uniNameString,
                                            portName, portNumber);
    }
    if (!(status >= 0L)) {
      {} {
    ...
    {}
  targetExit : { /*   RtlFreeUnicodeString(& uniNameString); */ /* INLINED */
  }
    return (deviceObject);
  }
}
...
NTSTATUS PptWmiQueryWmiRegInfo(PDEVICE_OBJECT PDevObj, PULONG PRegFlags,
                               ...
                               PDEVICE_OBJECT *Pdo);
NTSTATUS PptWmiQueryWmiDataBlock(PDEVICE_OBJECT DeviceObject, PIRP Irp,
...
GUID PptWmiAllocFreeCountsGuid = {
    ...
    if (GuidIndex == 0) {
    ...
    } else {
      {
        ...
        switch_327_0: /* CIL Label */;
          ...
          *((struct _PARPORT_WMI_ALLOC_FREE_COUNTS *)Buffer) =
                  ...
                  if (__BLAST_NONDET == 8) {
                    ...
                    if (__BLAST_NONDET == 11) {
                    ...
                    } else {
                      {
                        ...
                        {
                          status =
                              PptDispatchInternalDeviceControl(&devobj, pirp);
                        }
                          goto switch_328_break;
