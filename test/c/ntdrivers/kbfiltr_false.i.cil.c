...
enum _TRANSMIT_STATE { Idle = 0, SendingBytes = 1 };
...
enum _KEYBOARD_SCAN_STATE { Normal = 0, GotE0 = 1, GotE1 = 2 };
...
struct _INTERNAL_I8042_HOOK_KEYBOARD {
  ...
  (PVOID InitializationContext, PVOID SynchFuncContext,
   NTSTATUS (*ReadPort)(PVOID Context, PUCHAR Value, BOOLEAN WaitForACK),
...
NTSTATUS KbFilter_InitializationRoutine(
    PDEVICE_OBJECT DeviceObject, PVOID SynchFuncContext,
    NTSTATUS (*ReadPort)(PVOID Context, PUCHAR Value, BOOLEAN WaitForACK),
    NTSTATUS (*WritePort)(PVOID Context, UCHAR Value, BOOLEAN WaitForACK),
    PBOOLEAN TurnTranslationOn);
...
NTSTATUS KbFilter_AddDevice(PDRIVER_OBJECT Driver, PDEVICE_OBJECT PDO) {
...

  {
    {
      status = 0L;
      status = IoCreateDevice(Driver, sizeof(DEVICE_EXTENSION), (void *)0, 11,
                              0, 0, &device);
    }
    if (!(status >= 0L)) {
      return (status);
...
NTSTATUS KbFilter_Complete(PDEVICE_OBJECT DeviceObject, PIRP Irp,
                           PVOID Context) {
  PKEVENT event;
      ...
      if (irpStack->MajorFunction == 2) {
        ...
        switch_0_0: /* CIL Label */;
          if ((unsigned int)((void *)0) ==
              (unsigned int)devExt->UpperConnectData.ClassService) {
            status = -1073741436L;
          } else {
                  ...
                  if (irpStack->Parameters.DeviceIoControl.IoControlCode ==
                    ...
                    if (irpStack->Parameters.DeviceIoControl.IoControlCode ==
                      ...
                      switch_1_exp_0: /* CIL Label */;
                        if ((unsigned int)devExt->UpperConnectData
                                .ClassService != (unsigned int)((void *)0)) {
                          status = -1073741757L;
                          goto switch_1_break;
                        } else {
                          if (irpStack->Parameters.DeviceIoControl
                                  .InputBufferLength <
                              (ULONG)sizeof(CONNECT_DATA)) {
                            status = -1073741811L;
                            goto switch_1_break;
                          } else {
                          }
                        ...
                        connectData =
                            (struct _CONNECT_DATA *)irpStack->Parameters
                      ...
                      switch_1_exp_2: /* CIL Label */;
                        if (irpStack->Parameters.DeviceIoControl
                                .InputBufferLength <
                            (ULONG)sizeof(INTERNAL_I8042_HOOK_KEYBOARD)) {
                          status = -1073741811L;
                          goto switch_1_break;
                        } else {
                        }
                        hookKeyboard =
                            (struct _INTERNAL_I8042_HOOK_KEYBOARD *)irpStack
                        ...
                        hookKeyboard->InitializationRoutine = (NTSTATUS(*)(
                            PVOID InitializationContext, PVOID SynchFuncContext,
                        ...
                        hookKeyboard->IsrRoutine = (BOOLEAN(*)(
                            PVOID IsrContext, PKEYBOARD_INPUT_DATA CurrentInput,
                            POUTPUT_PACKET CurrentOutput, UCHAR StatusByte,
                        ...
                        devExt->QueueKeyboardPacket =
                            hookKeyboard->QueueKeyboardPacket;
...
BOOLEAN KbFilter_IsrHook(PDEVICE_OBJECT DeviceObject,
...

  {
    ...
    if (devExt->UpperIsrHook) {
      {
        retVal = (*(devExt->UpperIsrHook))(devExt->UpperContext, CurrentInput,
                                           CurrentOutput, StatusByte, DataByte,
  ...
  {
    {
      ...
      (*((void (*)(
          ...
          PVOID SystemArgument3))devExt->UpperConnectData.ClassService))(
          devExt->UpperConnectData.ClassDeviceObject, InputDataStart,
